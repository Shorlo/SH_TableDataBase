 ...
 * @author Shorlo
 */
public class SH_ChartJFrameSCRUD extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SH_ChartJFrameSCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SH_ChartJFrameSCRUD().setVisible(true);
            }
        });
    }
