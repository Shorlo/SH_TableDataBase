 ...
 * @author Shorlo
 */
public class SH_ChartJFrame extends javax.swing.JFrame {

    /**
     * Creates new form SH_ChartJFrame
     */
    public SH_ChartJFrame() 
    {
        initComponents(); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SH_ChartJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SH_ChartJFrame().setVisible(true);
            }
        });
    }
